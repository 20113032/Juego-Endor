...
class Enemy(pg.sprite.Sprite):
    ...
    def setup_enemy(self, x, y, direction, name, setup_frames):
        ...
        self.sprite_sheet = setup.GFX['stormtrooper']
        self.frames = []
        self.frame_index = 0
...
class Goomba(Enemy):
    ...
    def setup_frames(self):
        ...
        self.frames.append(
            self.get_image(0, 0, 15, 32))
        self.frames.append(
            self.get_image(15, 0, 15, 32))
        self.frames.append(
            self.get_image(30, 0, 15, 32))
        self.frames.append(
            self.get_image(0, 32, 16, 32))
        self.frames.append(
            self.get_image(16, 32, 17, 32))
        self.frames.append(
            self.get_image(33, 32, 17, 32))
