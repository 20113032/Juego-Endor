...
class Mario(pg.sprite.Sprite):
    def __init__(self):
        ...
        self.sprite_sheet = setup.GFX['luke']
    ...
    def load_images_from_sheet(self):
        ...
        self.right_small_normal_frames.append(
            self.get_image(0, 0, 22, 31))  # parado [0]
        self.right_small_normal_frames.append(
            self.get_image(22,  0, 27, 31))  # caminar derecha [1]
        self.right_small_normal_frames.append(
            self.get_image(49,  0, 24, 31))  # caminar derecha [2]
        self.right_small_normal_frames.append(
            self.get_image(73,  0, 28, 31))  # caminar derecha [3]
        self.right_small_normal_frames.append(
            self.get_image(101, 0, 22, 31))  # caminar derecha [4]
        self.right_small_normal_frames.append(
            self.get_image(123, 0, 26, 31))  # saltar derecha [5]
        self.right_small_normal_frames.append(
            self.get_image(149, 0, 21, 31))  # saltar derecha [6]
        self.right_small_normal_frames.append(
            self.get_image(170, 0, 24, 31))  # morir derecha [7]
        self.right_small_normal_frames.append(
            self.get_image(194, 0, 33, 31))  # morir derecha [8]
        self.right_small_normal_frames.append(
