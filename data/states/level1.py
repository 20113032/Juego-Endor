...
class Level1(tools._State):
    ...
    def setup_bricks(self):
        ...
        brick1  = bricks.Brick(858,  400)
        brick2  = bricks.Brick(944,  400)
        brick3  = bricks.Brick(1030, 400)
        brick4  = bricks.Brick(3299, 400)
        brick5  = bricks.Brick(3385, 400)
        brick6  = bricks.Brick(3430, 250)
        brick7  = bricks.Brick(3473, 250)
        brick8  = bricks.Brick(3516, 250)
        brick9  = bricks.Brick(3559, 250)
        brick10 = bricks.Brick(3602, 250)
        brick11 = bricks.Brick(3645, 250)
        brick12 = bricks.Brick(3688, 250)
        brick13 = bricks.Brick(3731, 250)
        brick14 = bricks.Brick(3901, 250)
        brick15 = bricks.Brick(3944, 250)
        brick16 = bricks.Brick(3987, 250)
        brick17 = bricks.Brick(4030, 400, c.SIXCOINS, self.coin_group)
        brick18 = bricks.Brick(4287, 400)
        brick19 = bricks.Brick(4330, 400, c.STAR, self.powerup_group)
        brick20 = bricks.Brick(5058, 250)
        brick21 = bricks.Brick(5187, 250)
        brick22 = bricks.Brick(5230, 250)
        brick23 = bricks.Brick(5273, 250)
        brick24 = bricks.Brick(5488, 250)
        brick25 = bricks.Brick(5574, 250)
        brick26 = bricks.Brick(5617, 250)
        brick27 = bricks.Brick(5531, 400)
        brick28 = bricks.Brick(5574, 400)
        brick29 = bricks.Brick(7202, 400)
        brick30 = bricks.Brick(7245, 400)
        brick31 = bricks.Brick(7331, 400)
    ...
    def setup_coin_boxes(self):
        ...
        coin_box1  = coin_box.Coin_box(685, 400, c.COIN, self.coin_group)
        coin_box2  = coin_box.Coin_box(901, 400, c.LIFE_MUSHROOM, self.powerup_group)
        coin_box3  = coin_box.Coin_box(987, 400, c.COIN, self.coin_group)
        coin_box4  = coin_box.Coin_box(943, 250, c.COIN, self.coin_group)
        coin_box5  = coin_box.Coin_box(3342, 400, c.LIFE_MUSHROOM, self.powerup_group)
        coin_box6  = coin_box.Coin_box(4030, 250, c.COIN, self.coin_group)
        coin_box7  = coin_box.Coin_box(4544, 400, c.COIN, self.coin_group)
        coin_box8  = coin_box.Coin_box(4672, 400, c.COIN, self.coin_group)
        coin_box9  = coin_box.Coin_box(4672, 400, c.LIFE_MUSHROOM, self.powerup_group)
        coin_box10 = coin_box.Coin_box(4800, 400, c.COIN, self.coin_group)
        coin_box11 = coin_box.Coin_box(5531, 250, c.COIN, self.coin_group)
        coin_box12 = coin_box.Coin_box(7288, 400, c.COIN, self.coin_group)
